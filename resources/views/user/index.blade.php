                                        ...
                                        <div class="flex space-x-3">
                                            @if ($data->is_admin)
                                                <form action="{{ route('user.removeadmin', $data) }}" method="POST">
                                                    ...
                                                    @method('PATCH')
                                                    <button type="submit"
                                                        class="text-xs text-blue-600 dark:text-blue-400 whitespace-nowrap hover:underline">
                                                        Remove Admin
                                                    </button>
                                                </form>
                                            @else
                                                <form action="{{ route('user.makeadmin', $data) }}" method="POST">
                                                    ...
                                                    @method('PATCH')
                                                    <button type="submit"
                                                        class="text-xs text-red-600 dark:text-red-400 whitespace-nowrap hover:underline">
                                                        Make Admin
                                                    </button>
                                                </form>
                                            @endif
